...
import com.example.womenentrepreneur.SignUp3;

import java.util.List;
import java.util.Locale;

public class NewGroupsAdapter extends RecyclerView.Adapter<NewGroupsAdapter.LeadData>{

    List<Meetups> dataholder2;
...
//    private FirebaseFirestore firebaseFirestore;
    ...
    public NewGroupsAdapter(List<Meetups> dataholder2, Context context) {
    ...
    public void setFilteredList(List<Meetups> filteredList) {
...
//        init();
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.meetupcard,parent,false);
    ...
    public void onBindViewHolder(@NonNull LeadData holder, int position) {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                        ...
                        Intent intent = new Intent(context, MeetupNext.class);

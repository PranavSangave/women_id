...
public class PopularNowAdapter extends RecyclerView.Adapter<PopularNowAdapter.LeadData>{
...
//    private FirebaseFirestore firebaseFirestore;
    ...
    public PopularNowAdapter(List<Meetups> dataholder2, Context context) {

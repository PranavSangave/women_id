...
public class OrganizationAdapter extends RecyclerView.Adapter<OrganizationAdapter.LeadData>{
    ...
    public OrganizationAdapter(List<InvestorModel> dataholder2, Context context) {
...
//        init();
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.orgnizationcard  ,parent,false);
